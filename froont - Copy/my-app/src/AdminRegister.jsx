...
{/* -_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-S-u-b-j-e-c-t-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-____________________________________________ */}
...
{/* ____________________________________________________________________________________________________________________________ */}
                      ...
                      <div className="d-grid mb-2">
                        {isloading?  <button type="button"  className="btn btn-lg btn-primary btn-login fw-bold text-uppercase text-white" ><i className='fas fa-spinner fa-spin'></i></button> :<button type="submit"  className="btn btn-lg btn-primary btn-login fw-bold text-uppercase" >Register</button>}
